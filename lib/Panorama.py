...
class Panorama:
    ...
    def getMatriceA(friendlyPoints):
        ...
        ecartKPLeft = np.sqrt(((friendlyPoints[0][0][1]-friendlyPoints[1][0][1])**2) + ((friendlyPoints[0][0][0]-friendlyPoints[1][0][0])**2))
        ecartKPRight = np.sqrt(((friendlyPoints[0][1][1]-friendlyPoints[1][1][1])**2) + ((friendlyPoints[0][1][0]-friendlyPoints[1][1][0])**2))
